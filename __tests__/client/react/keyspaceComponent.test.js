...
describe("React Keyspace unit tests", () => {
  ...
  describe("valueDisplay", () => {
    ...
    beforeAll(() => {
      wrapper = shallow(<div id='valueDisplay' props={props.keyspace[props.currDatabase]} />);
    });
  ...
  describe("keyListHolder", () => {
    ...
    beforeAll(() => {
      wrapper = shallow(<div id='keyListHolder' props={props.keyspace[props.currDatabase]} />);
    });
  ...
  describe("KeyListComponent", () => {
    ...
    beforeAll(() => {
      wrapper = shallow(<KeyListComponent props={props.keyspace[props.currDatabase]} />);
    });
